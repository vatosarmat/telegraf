...
exports.allOf = exports.anyOf = exports.callbackQuery = exports.editedChannelPost = exports.channelPost = exports.editedMessage = exports.businessMessage = exports.message = void 0;
...
const businessMessage = (...keys) => (update) => {
    if (!('business_message' in update))
        return false;
    for (const key of keys) {
        if (!(key in update.business_message))
            return false;
    }
    return true;
};
