...
export declare class Context<U extends Deunionize<tg.Update> = tg.Update> {
     ...
     */
    editMessageText(text: string | FmtString, extra?: tt.ExtraEditMessageText): Promise<true | (tg.Update.Edited & tg.Message.TextMessage & tg.Message.BusinessSentMessage)>;
    /**
